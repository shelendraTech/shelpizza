    ...
    >
      <div className="container w-full max-w-md">
        ...
        >
          ...
          <button
            type="submit"
            className=" w-full border font-bold text-gray-900 dark:text-gray-100 dark:border-gray-400 border-gray-900 rounded p-2 mr-2 hover:bg-gradient-to-r from-emerald-700 via-emerald-700 to-emerald-700  hover:text-gray-100"
          >
            Signup
          </button>
          <Link href={"/login"} style={{ all: "unset" }}>
            <button className=" mt-2 border text-gray-900 dark:text-gray-100 font-bold dark:border-gray-400 border-gray-900 rounded mr-2 p-2 hover:bg-gradient-to-r from-emerald-700 via-emerald-700 to-emerald-700  hover:text-gray-100">
              Already a user?
            </button>
          </Link>
        </form>
